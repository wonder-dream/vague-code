...
vague-code 的文档按用途分层。**文章（articles/）是面向阅读的成品文档**；ADR / 计划 / 交接是工程记录。
...
| 想做什么 | 去哪里 |
|----------|--------|
| 从零了解 vague-code（架构/子系统/教程/参考） | [`articles/README.md`](articles/README.md)（24 篇成品文章，6 阶段阅读路径） |
| 跑评测 / 理解评测体系 | [`../eval/README.md`](../eval/README.md)（现行）+ [`plans/0016-eval-methods.md`](plans/0016-eval-methods.md)（设计）+ [`handoff/2026-08-03-vague-code-eval-system.md`](handoff/2026-08-03-vague-code-eval-system.md)（重建与策展全记录） |
...
docs/handoff/2026-08-03-vague-code-eval-system.md  全量总结（重建、策展、踩坑、待办、面试故事）
