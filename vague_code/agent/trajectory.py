    ...
    def from_db(cls, run_id: str, db_path: str) -> Trajectory:
        ...
        try:
            ...
            if compression_data and isinstance(compression_data, dict):
                from vague_code.agent.config import CompressionConfig as CC
            ...
            if memory_data and isinstance(memory_data, dict):
                from vague_code.agent.config import MemoryConfig as MC
            ...
            if supervision_data and isinstance(supervision_data, dict):
                from vague_code.agent.config import SupervisionConfig as SC
