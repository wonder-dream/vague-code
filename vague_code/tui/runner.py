"""VagueCodeAgentRunner: bridge between the synchronous Agent and the async Textual UI.

The vague-code Agent runs in a worker thread (`@work(thread=True)`); this runner owns
