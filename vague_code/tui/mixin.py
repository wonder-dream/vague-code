...
from vague_code.tui.views.activity import tool_activity_line_text
from vague_code.tui.views.transcript import entry_markdown_text
from vague_code.tui.widgets.common import VagueCodeMarkdown, _observe_markdown_update
from vague_code.tui.widgets.conversation import ConversationView

_TURN_START_ACTIVITY = "planning next step..."


class VagueCodeViewMixin:
    ...
    def _reset_stream_state(self) -> None:
        ...
        self._stream_text_widget: VagueCodeMarkdown | None = None
